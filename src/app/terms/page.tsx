        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm space-y-8">
          <section>
            ...
            <p className="text-slate-700 leading-relaxed">
              本利用規約（以下「本規約」といいます。）は、足立区補助金ナビ（以下「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下「ユーザー」といいます。）には、本規約に従って本サービスをご利用いただきます。
            </p>
          </section>
          ...
          <section>
            ...
            <div className="text-slate-700 leading-relaxed space-y-3">
              ...
              <p>
                3. 本サービスで提供する補助金情報は参考情報であり、実際の申請にあたっては、各補助金の公式情報をご確認ください。当社は、本サービスで提供する情報の正確性、完全性、最新性を保証するものではありません。
              </p>
            </div>
          </section>
